...
plotBoxplot(data, data$address, data$G3, title = 'Calificacion final segun el nivel educativo de la madre', subtitle = 'Distribucion de las calificaciones teniendo en cuenta el tipo de domicilio del estudiante', ylabel = 'Calificacion final')
